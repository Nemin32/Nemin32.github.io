...
{% include caption.html url="/imgs/stateofplay/shrykull.avif" description="" %}
...
{% include caption.html url="/imgs/stateofplay/feeco1.avif" description="Yes, this is FeeCo, we'll speak about it more just down the line." %}
...
{% include caption.html url="/imgs/stateofplay/gunned.avif" description="" %}
...
{% include caption.html url="/imgs/stateofplay/baron.avif" description="Finally it's confirmed that the skull is a Mudokon's." %}

You know, I have to wonder how they exactly sit in these chairs. Their anatomy doesn't really seem to be built for them.

{% include caption.html url="/imgs/stateofplay/baron2.avif" description="" %}
...
{% include caption.html url="/imgs/stateofplay/feeco.avif" description="" %}
...
{% include caption.html url="/imgs/stateofplay/boiler.avif" description="Ze boilah?!" %}
...
{% include caption.html url="/imgs/stateofplay/orb.avif" description="" %}
...
{% include caption.html url="/imgs/stateofplay/placeholder.avif" description="" %}

You knew he will be there. I knew he will be there. Jokes aside I'm still wondering how he fits into the whole picture.

## Jumping Slig

{% include caption.html url="/imgs/stateofplay/jump.avif" description="<a href='https://www.youtube.com/watch?v=XZ5Uv4JKTU4'>Woo-oo-oooh-ooh-ooh!</a>" %}
...
{% include caption.html url="/imgs/stateofplay/loincloth.avif" description="" %}
...
{% include caption.html url="/imgs/stateofplay/sligbarracks.avif" description="" %}
...
{% include caption.html url="/imgs/stateofplay/notentacles.avif" description="" %}
...
{% include caption.html url="/imgs/stateofplay/worker.avif" description="" %}
...
{% include caption.html url="/imgs/stateofplay/extractors.avif" description="" %}
...
{% include caption.html url="/imgs/stateofplay/greeter.avif" description="The lighting zapping through the mouth..." %}
...
{% include caption.html url="/imgs/stateofplay/disappear.avif" description="Abe literally disappears after dying..." %}

{% include caption.html url="/imgs/stateofplay/gibs.avif" description="Only to reappear as like 5-10 chunks of meat." %}
...
{% include caption.html url="/imgs/stateofplay/slogs.avif" description="" %}

Other than losing most of their pigment, Slogs seem to be back for Soulstorm.

## Tying up sleeping Sligs

{% include caption.html url="/imgs/stateofplay/rope.avif" description="Tying up Sligs... by doing a weird dance." %}
...
{% include caption.html url="/imgs/stateofplay/possession.avif" description="" %}
...
{% include caption.html url="/imgs/stateofplay/greendot.avif" description="Look at the top right corner." %}
...
{% include caption.html url="/imgs/stateofplay/infinite.avif" description="" %}
...
{% include caption.html url="/imgs/stateofplay/run.avif" description="" %}
...
{% include caption.html url="/imgs/stateofplay/run2.avif" description="Hey, we have seen this before!" %}
...
{% include caption.html url="/imgs/stateofplay/aslik.avif" description="" %}
...
{% include caption.html url="/imgs/stateofplay/bloom.avif" description="" %}

Old habits die way too damn hard.

## Chest tattoo

{% include caption.html url="/imgs/stateofplay/scar.avif" description="" %}
