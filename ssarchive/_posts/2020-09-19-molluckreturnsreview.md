...
{% include caption.html url="/imgs/molre2/molluck.avif" description='<i>"My god, Molluck, what are you doing, eh?"</i>' %}
...
{% include caption.html url="/imgs/molre2/pilot.avif" description="- So you're saying he's the best character?<br>- It sounds idiotic, but that's exactly what he looks like." %}
...
{% include caption.html url="/imgs/molre2/monsaic.avif" description="Notice the light emanating from the ceiling." %}
...
{% include caption.html url="/imgs/molre2/ps4.avif" description="" %}
...
{% include caption.html url="/imgs/molre2/gorge.avif" description="Notice how there is Royal Jelly on a path you otherwise probably wouldn't take." %}
...
{% include caption.html url="/imgs/molre2/mines.avif" description="" %}
...
{% include caption.html url="/imgs/molre2/orb_on.avif" description="" %}

{% include caption.html url="/imgs/molre2/orb_off.avif" description="" %}
...
{% include caption.html url="/imgs/molre2/desert.avif" description="I don't really like the fences glistering this much, but it's a pretty minor thing to note." %}
...
{% include caption.html url="/imgs/molre2/noorb.avif" description="" %}
...
{% include caption.html url="/imgs/molre2/orb.avif" description="" %}
...
{% include caption.html url="/imgs/molre2/furnace.avif" description="" %}
...
{% include caption.html url="/imgs/molre2/aofurnace.avif" description="" %}
...
{% include caption.html url="/imgs/molre2/rf.avif" description="" %}

## Molluck 2: "Boss Fight"

{% include caption.html url="/imgs/molre2/blimp.avif" description="" %}
