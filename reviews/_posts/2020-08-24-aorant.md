...
{% include caption.html url="/imgs/aorant/cover.avif" description="The cover of Abe's Oddysee" %}
...
{% include caption.html url="/imgs/aorant/sliggun.avif" description='"What am I waving again?"' %}
...
{% include caption.html url="/imgs/aorant/stockyards.avif" description="Credits: <a href='https://vgmaps.com/Atlas/PSX/index.htm#OddworldAbesOddysee'>Abe's Oddysee on vgmaps.com</a>" %}
...
{% include caption.html url="/imgs/aorant/lynched.avif" description="Notice how the distant moon is contrasts the dark silhouettes of the dead Mudokons." %}
...
{% include caption.html url="/imgs/aorant/paramonia_temple.avif" description="I am also a huge fan of those windmills you can see in the distance. Knowing that these areas are devoid of native Mudokons, they present an eerie reminder that there used to be a civilization here." %}
...
{% include caption.html url="/imgs/aorant/scrabania.avif" description="Notice how you can see the temples in the starting screen of both Paramonia and Scrabania. Another point to the environmental storytelling." %}
...
{% include caption.html url="/imgs/aorant/scrabania_temple.avif" description="" %}
...
{% include caption.html url="/imgs/aorant/shrykull2.avif" description="The Shrykull in action!" %}
...
{% include caption.html url="/imgs/aorant/foreshadow.avif" description="Nice foreshadowing of the Boardroom countdown." %}

![Watch your back... and front](/imgs/aorant/slogfight.webp)

{% include caption.html url="/imgs/aorant/shutdown.avif" description="Good thing they made the button in the shape of a Mudokon hand." %}

### The Boardroom

{% include caption.html url="/imgs/aorant/boardroom.avif" description="Perhaps the most memorable screen of the whole Boardroom gauntlet." %}
...
{% include caption.html url="/imgs/aorant/bladder.avif" description="Concept art about the bladders." %}
