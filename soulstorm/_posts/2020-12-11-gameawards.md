...
{% include caption.html url="/imgs/gameawards/statue.webp" description="" %}
...
{% include caption.html url="/imgs/gameawards/statue2.webp" description="<i>'This edible ain't shit'</i><br>Five minutes later:" %}
...
{% include caption.html url="/imgs/gameawards/vault.webp" description="" %}
...
{% include caption.html url="/imgs/gameawards/rip.webp" description="RIP." %}
...
{% include caption.html url="/imgs/gameawards/necrumstone.webp" description="Good old Exoddus, still holds up so well..." %}
...
{% include caption.html url="/imgs/gameawards/xtractor.webp" description="Still about as silly as they were back in AE." %}
...
{% include caption.html url="/imgs/gameawards/sign.webp" description="The sign confirms that these are still called X-Tractors" %}
...
{% include caption.html url="/imgs/gameawards/baron.webp" description="The Baron... or Squidward's grandfather as some like to call him." %}
...
{% include caption.html url="/imgs/gameawards/necrumsign.webp" description="Also notice that unlike in previous GIFs the numbers of employees and casualties aren't in the thousands anymore." %}
...
{% include caption.html url="/imgs/gameawards/escape.webp" description="" %}
...
{% include caption.html url="/imgs/gameawards/turrets.webp" description="" %}

In this next scene we see what appears to be laser traps that pepper anything that walks into their
line of sight.

{% include caption.html url="/imgs/gameawards/turrets2.webp" description="" %}
...
{% include caption.html url="/imgs/gameawards/grinder.webp" description="" %}
...
{% include caption.html url="/imgs/gameawards/flamethrower.webp" description="" %}
...
{% include caption.html url="/imgs/gameawards/pendant.webp" description="Sorry for the quality, I'm working with literally the best we have." %}
...
{% include caption.html url="/imgs/gameawards/munch.webp" description="" %}
...
{% include caption.html url="/imgs/gameawards/orb.webp" description="" %}
...
{% include caption.html url="/imgs/gameawards/nnt.webp" description="I call this the NnT Experience." %}

## Placeholder Dripik / Weird sign

{% include caption.html url="/imgs/gameawards/dripik.webp" description="" %}
...
{% include caption.html url="/imgs/gameawards/forbidden.webp" description="" %}
...
{% include caption.html url="/imgs/gameawards/train.webp" description="" %}
...
{% include caption.html url="/imgs/gameawards/pressureplate.webp" description="Watch your step..." %}

{% include caption.html url="/imgs/gameawards/trap.webp" description="...or else you might step in something you'd rather not want to." %}
...
{% include caption.html url="/imgs/gameawards/doublejump.webp" description="" %}
...
{% include caption.html url="/imgs/gameawards/escape2.webp" description="" %}
...
{% include caption.html url="/imgs/gameawards/rockets.webp" description="Looks like a jeering face, if you ask me." %}
...
{% include caption.html url="/imgs/gameawards/monsters.webp" description="Interestingly unlike previously their eyes seem to be a uniform red now, instead of several colors." %}
...
{% include caption.html url="/imgs/gameawards/monsters2.webp" description="" %}
