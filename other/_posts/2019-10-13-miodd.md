...
{% include caption.html url="/imgs/miodd/deadmud.avif" description="" %}
...
{% include caption.html url="/imgs/miodd/hb_ae.avif" description="" %}
...
{% include caption.html url="/imgs/miodd/happybd.avif" description="" %}
...
{% include caption.html url="/imgs/miodd/MO_Quiz.avif" description="The first and only Lore Quiz." %}

A project that became dead on arrival, Lore Quizzes were an idea by
OWI_Lewis with the intention to give us something to do while we were
...
{% include caption.html url="/imgs/miodd/oddwall.avif" description="" %}
...
{% include caption.html url="/imgs/miodd/dearalf.avif" description="Compared to the old Dear Alf posts' 8-10 questions and answers, this feels rather lacking." %}
...
another set of questions, ending his post with: _"That’s it
...
your burning questions."_ Despite this promise, it took
...
{% include caption.html url="/imgs/miodd/pstheme.avif" description="" %}
...
{% include caption.html url="/imgs/insta_images/25022422_472243246504002_8271305566903599104_n.avif" description="" %}
...
{% include caption.html url="/imgs/miodd/source1.avif" description="" %}

{% include caption.html url="/imgs/miodd/source2.avif" description="" %}

{% include caption.html url="/imgs/miodd/source3.avif" description="" %}
...
{% include caption.html url="/imgs/miodd/pic5.avif" description="<a href='https://web.archive.org/web/20170224023128/http://oddworld.com/soulstorm/'>Web Archive</a> link for the curious.
"%}
...
{% include caption.html url="/imgs/miodd/arg.avif" description="" %}{:.original}

### The Social Media Puzzle Game (November 2020)

{% include caption.html url="/imgs/miodd/socmed2.avif" description="A locked page... This is as far as we ever got." %}
...
{% include caption.html url="/imgs/miodd/socmed.avif" description="At the time of writing, OWI has lost a little more than 650 followers on their Facebook compared to when the game started." %}
