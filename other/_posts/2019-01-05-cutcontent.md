...
{% include caption.html url="/imgs/cutcontent/mudombie2.avif" description="Freaky!" %}

{% include caption.html url="/imgs/cutcontent/mudombie.avif" description="Also older variants of the Fleeches, they resemble furless Fuzzles." %}
...
{% include caption.html url="/imgs/cutcontent/guardian.avif" description="Despite their ability, that orifice has a very unfortunate appearance." %}
...
{% include caption.html url="/imgs/cutcontent/roid.avif" description="" %}
